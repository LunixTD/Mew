...
public class ReactCusScrollView extends NestedScrollView implements ReactClippingViewGroup, ViewGroup.OnHierarchyChangeListener, View.OnLayoutChangeListener {
    ...
    public ReactCusScrollView(ReactContext context) {
        this(context, null);
    }

    public ReactCusScrollView(ReactContext context, @Nullable FpsListener fpsListener) {
        super(context);
...
//    dddddddddddddddddddddddd
    ...
    {
        if (getScrollY() >= 400) return false;
        return true;
    }
        ...
        mPostTouchRunnable = new Runnable() {
            ...
            public void run() {
                if (mActivelyScrolling) {
                    ...
                    mActivelyScrolling = false;
                    ViewCompat.postOnAnimationDelayed(ReactCusScrollView.this,
                            this,
                    ...
                    if (mPagingEnabled && !mSnappingToPage) {
                        ...
                        if (mSendMomentumEvents) {
                            ReactScrollViewHelper.emitScrollMomentumEndEvent(ReactCusScrollView.this);
                        }
                        ReactCusScrollView.this.mPostTouchRunnable = null;
                        disableFpsListener();
                    }
                }
            }
